...
import { Menu, Upload, Settings, Image, Users } from 'lucide-react';
...
const MenuBar: React.FC<MenuBarProps> = ({ onUploadImages, onSetLimit, currentLimit, wishCount, imageCount }) => {
